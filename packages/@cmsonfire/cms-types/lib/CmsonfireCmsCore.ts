...
export interface CmsRegistry {
  ...
  editorComponents: Map<string, React.ComponentType<any>>;
...
export interface CMS {
  ...
  getEditorComponents: () => Map<string, React.ComponentType<any>>;
  ...
  getPreviewTemplate: (
    name: string
  ) => React.ComponentType<PreviewTemplateComponentProps> | undefined;
